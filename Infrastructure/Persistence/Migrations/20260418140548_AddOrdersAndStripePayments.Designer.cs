...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260418140548_AddOrdersAndStripePayments")]
    partial class AddOrdersAndStripePayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "order_item_status", new[] { "pending", "completed", "failed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "order_status", new[] { "pending", "completed", "partially_failed", "failed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "stripe_event_processing_status", new[] { "processing", "completed", "failed" });
            ...
            modelBuilder.Entity("Domain.Entities.StripeEventProcessing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<StripeEventProcessingStatus>("Status")
                        .HasColumnType("stripe_event_processing_status");
                    ...
                    b.ToTable("Stripe_Event_Processing");
                });
